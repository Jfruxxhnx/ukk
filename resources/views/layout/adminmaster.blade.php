                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{asset('admin/dist/assets/img/user1-128x128.jpg')}}"
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{asset('admin/dist/assets/img/user8-128x128.jpg')}}"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{asset('admin/dist/assets/img/user3-128x128.jpg')}}"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item {{ request()->is('admin/fashion*') || request()->is('admin/category*') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ request()->is('admin/fashion*') || request()->is('category*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/admin/fashion"
                                        class="nav-link {{ request()->is('admin/fashion') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Semua Pakaian</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="fashion/create" class="nav-link {{ request()->is('admin/fashion/create') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Tambah Pakaian</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ request()->is('admin/laporan*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="laporan" class="nav-link {{ request()->is('admin/laporan*') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Semua Laporan</p>
                                    </a>
                                </li>
