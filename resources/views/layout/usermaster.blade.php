                ...
                <div class="modal-body">
                    <div class="col-lg-12 col-md-12 me-3">
                        <div class="image-holder">
                            <img src="{{asset('user/images/summary-item1.jpg')}}" alt="Shoes">
                        </div>
                    </div>
                        ...
                        <div class="shopping-cart-content">
                                ...
                                <div class="mini-cart-item d-flex border-bottom pb-3">
                                    <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                                        <a href="#" title="product-image">
                                            <img src="{{asset('user/images/single-product-thumb1.jpg')}}"
                            ...
                            <div class="mini-cart cart-list p-0 mt-3">
                                <div class="mini-cart-item d-flex border-bottom pb-3">
                                    <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                                        <a href="#" title="product-image">
                                            <img src="{{asset('user/images/single-product-thumb2.jpg')}}"
                                                class="img-fluid" alt="single-product-item">
                                        </a>
                                    </div>
                                    <div class="col-lg-9 col-md-8 col-sm-8">
        ...
        <nav id="header-nav" class="navbar navbar-expand-lg">
            <div class="container-lg">
                <a class="navbar-brand" href="index.html">
                    <img src="{{asset('user/images/main-logo.png')}}" class="logo" alt="logo">
                </a>
                ...
                <div class="user-items ps-0 ps-md-5">
                    <ul class="d-flex justify-content-end list-unstyled align-item-center m-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu fw-bold">
                                <li>
                                    <a href="index.html" class="dropdown-item">Profile </a>
                                </li>
                                <li>
