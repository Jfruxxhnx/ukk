                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form action="/admin/fashion/update/{{$fashion->slug}}" method="PUT">
                                @csrf
                                <!--begin::Body-->
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-5 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" name="name" value="{{ $fashion->name }}">
                                        ...
                                        <div class="col-3 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" name="price_per_day" value="{{ $fashion->price_per_day }}">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <textarea class="form-control" aria-label="With textarea"
                                                name="desc">{{ $fashion->desc }}</textarea>
                                        </div>
                                        <div class="col-6 mb-3">
